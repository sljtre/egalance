...
export class TuilesService {
  ...
  private data = [
    ...
    [{name: 'Moscow', tuiles: {hopital: 4, supermarche: 2, ecole: 3, ecoleSup: 1, cinema:2, bar:3, religion:1, justice: 1, mairie: 1, culturel: 1, parc: 2, habitations: 11, bureaux: 3, usine: 2, ferme: 1, bibliotheque: 2, gymnase: 1, musee: 1, restaurant: 2, banque: 1, stade: 1, aeroport: 1,vide:3}}],
    ...
    [{name: 'Johannesburg', tuiles : {hopital: 1, supermarche: 3, ecole: 1, ecoleSup: 1, cinema:1, bar:2, religion:1, justice: 1, mairie: 1, culturel: 1, parc: 2, habitations: 10, bureaux: 2, usine: 2, ferme: 1, bibliotheque: 2, gymnase: 1, musee: 1, restaurant: 2, banque: 1, stade: 1, aeroport: 1,vide:11}}],
    [{name: 'Beijing', tuiles : {hopital: 2, supermarche: 2, ecole: 2, ecoleSup: 1, cinema:3, bar:2, religion:1, justice: 1, mairie: 1, culturel: 1, parc: 3, habitations: 15, bureaux: 3, usine: 3, ferme: 1, bibliotheque: 2, gymnase: 1, musee: 1, restaurant: 2, banque: 1, stade: 1, aeroport: 1,vide:0}}]
  ];
